...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
    	final Product p1 = new ComparableProduct("Product2", 10);
        final Product p2 = new ComparableProduct("Product1", 20);
        final Product p3 = new ComparableProduct("Product1", 30);
